...
import "./mobileLargeCartButton.scss";
const MobileLargeCartButton = () => {
  return (
    <div className="mobilelargeCartButton">
      <button>
        <svg
          width="34"
          height="34"
        ...
        <span className="d-flex-column cart__info">
          <span className="fw-600">Add to Cart</span>
          <span className="color-green number__available-copies">
            23 Copies Available
          </span>
        </span>
...
export default MobileLargeCartButton;
